...
dat <- read.csv(file = file.path("/home/ycth8/data/GWAS1001/BLUP_BLUE/Arabidopsis_1001/BLUE_FAA_1001_full_dataset.csv"), 
                header = TRUE,
...
if(dir.exists("/home/ycth8/data/GWAS1001/reference_files/Arabidopsis_1001/GAPIT/")){
  print("dir exists")
}else{
...
for (i in start_column:ncol(dat)){
  Results <- GAPIT(
    Y = dat[,c(1,i)],
    file.Ext.G = "hmp.txt",
    file.G = "1001genomes_hmp_chr",
    file.from = 1,
    file.to = 5,
    file.path = "/home/ycth8/data/GWAS1001/reference_files/Arabidopsis_1001/GAPIT/"
  )
}